...
public class BasketBallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameBasketBall);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameBasketBall);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = BASKETBALL;
        basketBall = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", BASKETBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.basketball_image;

        String id = basketBall.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        basketBall.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
