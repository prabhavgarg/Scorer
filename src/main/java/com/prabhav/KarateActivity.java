...
public class KarateActivity extends AppCompatActivity {
    private final String KARATE = "Karate";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamANameHeading = (TextView)findViewById(R.id.teamANameKarate);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameKarate);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = KARATE;
        karate = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", KARATE);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.karate_icon;

        String id = karate.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        karate.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
