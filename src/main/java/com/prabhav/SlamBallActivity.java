...
public class SlamBallActivity extends AppCompatActivity {

    private final String SLAMBALL = "SlamBall";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slam_ball);
        textView = (TextView)findViewById(R.id.timer);
        start = (Button)findViewById(R.id.startButton);
        pause = (Button)findViewById(R.id.pauseButton);
        reset = (Button)findViewById(R.id.resetButton);
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameSlamBall);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameSlamBall);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = SLAMBALL;
        slamBall = FirebaseDatabase.getInstance().getReference();
    ...
    {
        if(scoreA>0&&Arr.get(total)==2){scoreA-=2;Arr.remove(total);total--;}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", SLAMBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.slamball_image;

        String id = slamBall.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        slamBall.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
