...
public class PickleBallActivity extends AppCompatActivity {

    private final String PICKLEBALL = "PickleBall";
    ...
    DatabaseReference pickleBall;
    ArrayList<Integer> Arr = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pickle_ball);
        TextView whoWho=(TextView) findViewById(R.id.who_won);
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANamePickleball);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNamePickleball);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = PICKLEBALL;
        pickleBall = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", PICKLEBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.pickleball_image;

        String id = pickleBall.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        pickleBall.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
