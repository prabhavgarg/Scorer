...
public class SquashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameSquash);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameSquash);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = SQUASH;
        squash = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", SQUASH);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.squash_image;
        String id = squash.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        squash.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
