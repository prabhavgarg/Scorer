...
public class ThrowBallActivity extends AppCompatActivity {

    private final String THROWBALL = "ThrowBall";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameThrowball);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameThrowball);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = THROWBALL;
        throwBall = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", THROWBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.throwball_image;

        String id = throwBall.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        throwBall.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
