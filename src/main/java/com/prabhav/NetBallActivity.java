...
public class NetBallActivity extends AppCompatActivity {
    private final String NETBALL = "NetBall";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameNetball);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameNetball);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = NETBALL;
        netBall = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", NETBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.netball_image;

        String id = netBall.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        netBall.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
