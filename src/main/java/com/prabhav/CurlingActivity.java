...
public class CurlingActivity extends AppCompatActivity {

    private final String CURLING = "Curling";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameCurling);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameCurling);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = CURLING;
        curling = FirebaseDatabase.getInstance().getReference();
    }
    ...
    private void updateResults() {
        ...
        else if(scoreA>1998&&scoreB>1998)
        {
            if(scoreA-scoreB==2)
                whoWon.setText(teamANameHeading.getText().toString()+" Won!!");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", CURLING);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.curling_image;

        String id = curling.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        curling.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
