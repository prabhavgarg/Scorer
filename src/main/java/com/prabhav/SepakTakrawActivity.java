...
public class SepakTakrawActivity extends AppCompatActivity {

    private final String SEPAKTAKRAW = "SepakTakraw";
    ...
    DatabaseReference sepakTakraw;
    ArrayList<Integer> Arr = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sepak_takraw);
        TextView whoWho=(TextView) findViewById(R.id.who_won);
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameSepakTakraw);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameSepakTakraw);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = SEPAKTAKRAW;
        sepakTakraw = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", SEPAKTAKRAW);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.sepak_takraw_image;

        String id = sepakTakraw.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        sepakTakraw.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
