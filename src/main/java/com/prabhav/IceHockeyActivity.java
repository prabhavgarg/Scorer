...
public class IceHockeyActivity extends AppCompatActivity {
    private final String ICEHOCKEY = "IceHockey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameIceHockey);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameIceHockey);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = ICEHOCKEY;
        iceHockey = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", ICEHOCKEY);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.ice_hockey_image;

        String id = iceHockey.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        iceHockey.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
