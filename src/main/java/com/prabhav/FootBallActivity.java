...
public class FootBallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamAName_football);
        teamBNameHeading = (TextView)findViewById(R.id.teamBName_football);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = FOOTBALL;
        footBall = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", FOOTBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.football_image;

        String id = footBall.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        footBall.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
