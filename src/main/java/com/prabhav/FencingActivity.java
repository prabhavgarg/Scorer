...
public class FencingActivity extends AppCompatActivity {
    private final String FENCING = "Fencing";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameFencing);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameFencing);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = FENCING;
        fencing = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", FENCING);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.fencing_image;

        String id = fencing.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        fencing.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
