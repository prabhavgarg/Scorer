...
public class KabaddiActivity extends AppCompatActivity {
    private final String KABADDI = "Kabaddi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamANameHeading = (TextView)findViewById(R.id.teamANameKabaddi);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameKabaddi);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = KABADDI;
        kabaddi = FirebaseDatabase.getInstance().getReference();
    ...
    private void updateResults() {
        TextView whoWon = (TextView) findViewById(R.id.who_won);
        if(scoreA>=5000&&scoreB<4999)
        {
            whoWon.setText("Team-A Won");
        }
        else if(scoreB>=5000&&scoreA<4999)
        {
            whoWon.setText("Team-B Won");
        }
        else if(scoreA>4998&&scoreB>4998)
        {
            if(scoreA-scoreB>=2)
                whoWon.setText("Team-A Won");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", KABADDI);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.kabaddi_image;

        String id = kabaddi.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        kabaddi.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
