...
public class KorfBallActivity extends AppCompatActivity {
    private final String KORFBALL = "KorfBall";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_korf_ball);
        textView = (TextView)findViewById(R.id.timer);
        start = (Button)findViewById(R.id.startButton);
        pause = (Button)findViewById(R.id.pauseButton);
        reset = (Button)findViewById(R.id.resetButton);
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameKorfBall);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameKorfBall);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = KORFBALL;
        korfball = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", KORFBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.korfball_image;

        String id = korfball.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        korfball.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
