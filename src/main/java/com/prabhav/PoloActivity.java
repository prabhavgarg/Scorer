...
public class PoloActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANamePolo);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNamePolo);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = POLO;
        polo = FirebaseDatabase.getInstance().getReference();
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.polo_image;

        String id = polo.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        polo.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
