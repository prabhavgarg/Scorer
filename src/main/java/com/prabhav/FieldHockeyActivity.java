...
public class FieldHockeyActivity extends AppCompatActivity {
    private final String FIELDHOCKEY = "FieldHockey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_field_hockey);
        textView = (TextView)findViewById(R.id.timer);
        start = (Button)findViewById(R.id.startButton);
        pause = (Button)findViewById(R.id.pauseButton);
        reset = (Button)findViewById(R.id.resetButton);
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameFieldHockey);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameFieldHockey);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = FIELDHOCKEY;
        fieldHockey = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", FIELDHOCKEY);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.field_hockey_image;

        String id = fieldHockey.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        fieldHockey.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
