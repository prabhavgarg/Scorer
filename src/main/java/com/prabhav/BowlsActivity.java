...
public class BowlsActivity extends AppCompatActivity {
    ...
    private final String BOWLS = "Bowls";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameBowls);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameBowls);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = BOWLS;
        bowls = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.bowls_image;

        String id = bowls.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        bowls.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
