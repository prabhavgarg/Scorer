...
public class BroomBallActivity extends AppCompatActivity {
    private final String BROOMBALL = "BroomBall";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_broom_ball);
        textView = (TextView)findViewById(R.id.timer);
        start = (Button)findViewById(R.id.startButton);
        pause = (Button)findViewById(R.id.pauseButton);
        reset = (Button)findViewById(R.id.resetButton);
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameBroomball);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameBroomball);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = BROOMBALL;
        broomball = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", BROOMBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.broomball_image;

        String id = broomball.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        broomball.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
