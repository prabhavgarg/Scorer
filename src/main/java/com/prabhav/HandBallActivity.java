...
public class HandBallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler() ;
        teamANameHeading = (TextView)findViewById(R.id.teamANameHandBall);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameHandball);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = HANDBALL;
        handball = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", HANDBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.handball_image;

        String id = handball.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        handball.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
