...
public class VolleyBallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameVolleyBall);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameVolleyBall);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = VOLLEYBALL;
        volleyBall = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", VOLLEYBALL);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.volleyball_image;

        String id = volleyBall.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        volleyBall.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
