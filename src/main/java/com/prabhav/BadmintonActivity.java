...
public class BadmintonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameBadminton);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameBadminton);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = BADMINTON;
        badminton = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", BADMINTON);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.badminton_image;

        String id = badminton.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        badminton.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
