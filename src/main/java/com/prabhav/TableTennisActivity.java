...
public class TableTennisActivity extends AppCompatActivity {
    ...
    private final String TABLETENNIS = "TableTennis";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whoWho.setText("");
        teamANameHeading = (TextView)findViewById(R.id.teamANameTableTennis);
        teamBNameHeading = (TextView)findViewById(R.id.teamBNameTableTennis);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = TABLETENNIS;
        tableTennis = FirebaseDatabase.getInstance().getReference();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", TABLETENNIS);
    ...
    public void pushingDataToFirebase(){
        ...
        int image =R.drawable.table_tennis_image;

        String id = tableTennis.push().getKey();
        AddScores addScores = new AddScores(image,id,teamAScore,teamBScore,d,gameName,aName,bName,comment);
        tableTennis.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
