...
public class BoxingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler();
        teamANameHeading = (TextView) findViewById(R.id.teamANameBoxing);
        teamBNameHeading = (TextView) findViewById(R.id.teamBNameBoxing);
        teamANameHeading.setText("Team A");
        teamBNameHeading.setText("Team B");
        gameName = BOXING;
        boxing = FirebaseDatabase.getInstance().getReference();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_history:
                ...
                intent.putExtra("GAME_ID", BOXING);
    ...
    public void pushingDataToFirebase() {
        ...
        int image = R.drawable.boxing_image;

        String id = boxing.push().getKey();
        AddScores addScores = new AddScores(image, id, teamAScore, teamBScore, d, gameName, aName, bName, comment);
        boxing.child(MainActivity.USER_ID).child(gameName).child(id).setValue(addScores);
